package com.example.danielasanchezollervides.numbers;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void checkNumber (View.view){
        EditText txtNumber = (EditText) findViewById (R.id.Inserta_tu_numero);
        TextView lblMessage = (TextView) findViewById(R.id.Respuesta
